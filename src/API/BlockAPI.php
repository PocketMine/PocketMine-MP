...
class BlockAPI{
	...
	public static $creative = array(
		...
		array(ICE, 0),
		array(SNOW_BLOCK, 0),
		array(HARDENED_CLAY, 0),
		array(STAINED_CLAY, 0),
		array(STAINED_CLAY, 7),
		array(STAINED_CLAY, 6),
		array(STAINED_CLAY, 5),
		array(STAINED_CLAY, 4),
		array(STAINED_CLAY, 3),
		array(STAINED_CLAY, 2),
		array(STAINED_CLAY, 1),
		array(STAINED_CLAY, 15),
		array(STAINED_CLAY, 14),
		array(STAINED_CLAY, 13),
		array(STAINED_CLAY, 12),
		array(STAINED_CLAY, 11),
		array(STAINED_CLAY, 10),
		array(STAINED_CLAY, 9),
		array(STAINED_CLAY, 8),
