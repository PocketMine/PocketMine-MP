...
class Effect{
	...
	public static function init(){
		...
		self::$effects[Effect::BLINDNESS] = new Effect(Effect::BLINDNESS, "%potion.blindness", 47, 87, 163, true);
		self::$effects[Effect::NIGHT_VISION] = new Effect(Effect::NIGHT_VISION, "%potion.nightVision", 22, 37, 75, true);
		//Hunger
