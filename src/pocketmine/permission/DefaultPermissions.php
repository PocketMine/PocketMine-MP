...
abstract class DefaultPermissions{
	...
	public static function registerCorePermissions(){
		...
		self::registerPermission(new Permission(self::ROOT . ".command.op", "Allows the user to give a player operator status"), $op);
		self::registerPermission(new Permission(self::ROOT . ".command.deop", "Allows the user to take a players operator status"), $op);
