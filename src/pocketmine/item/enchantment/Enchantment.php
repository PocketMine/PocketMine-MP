...
class Enchantment{
	...
	public static function init(){
		...
		self::$enchantments[self::TYPE_BOW_FLAME] = new Enchantment(self::TYPE_BOW_FLAME, "%enchantment.fire.bow", self::RARITY_UNCOMMON, self::ACTIVATION_HELD, self::SLOT_BOW);
	}
